...
export const CONTRACT_ADDRESSES = {
  // Sepolia Testnet
  11155111: {
    RENTAL_FACTORY: process.env.VITE_RENTAL_FACTORY_ADDRESS || '0x1234567890123456789012345678901234567890',
    PLATFORM_TOKEN: process.env.VITE_PLATFORM_TOKEN_ADDRESS || '0x0987654321098765432109876543210987654321'
  },
  // Ethereum Mainnet
  1: {
    RENTAL_FACTORY: process.env.VITE_MAINNET_RENTAL_FACTORY_ADDRESS || '',
    PLATFORM_TOKEN: process.env.VITE_MAINNET_PLATFORM_TOKEN_ADDRESS || ''
  },
  // Polygon Mainnet
  137: {
    RENTAL_FACTORY: process.env.VITE_POLYGON_RENTAL_FACTORY_ADDRESS || '',
    PLATFORM_TOKEN: process.env.VITE_POLYGON_PLATFORM_TOKEN_ADDRESS || ''
  }
}
